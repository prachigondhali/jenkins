...
class Topic():
    def __init__(self):
        ...
        self.sTicketDataFile="/ml/data/mockdata.csv"
        self.epoch=1000
...
# training set, bag of self.words for each sentence
        ...
        self.model.save('/ml/model/model_Topic.tflearn')
        pickle.dump( {'words':self.words, 'classes':self.classes, 'train_x':train_x, 'train_y':train_y}, open( "/ml/data/Path_training_data", "wb" ) )


    def reloadModelAndData(self):
        data = pickle.load( open("/ml/data/Path_training_data", "rb" ) )
...
# load our saved model
        self.model.load('/ml/model/model_Topic.tflearn')
